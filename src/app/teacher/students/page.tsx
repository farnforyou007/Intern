            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
                <div>
                    <h1 className="text-3xl font-black text-slate-900 flex items-center gap-3">
                        ...
                        <span>รายชื่อ <span className="text-blue-600">นักศึกษา</span></span>
                    </h1>
                    <p className="text-slate-400 font-bold mt-2 ml-1 text-[11px] uppercase tracking-[0.2em]">รายชื่อนักศึกษาและรายละเอียดสถานที่ฝึกงาน</p>
                </div>
            </div>
